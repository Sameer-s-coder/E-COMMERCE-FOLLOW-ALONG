...
export default function Profile() {
	...
	useEffect(() => {
		fetch(
			`http://localhost:5000/api/v2/user/profile?email=${"sameer123@gmail.com"}`,
			{
				method: "GET",
				headers: {
					...
					<div className="w-full h-max my-2 p-5">
						...
						<div className="w-full h-max flex flex-col sm:flex-row p-5 gap-10">
							<div className="w-40 h-max flex flex-col justify-center items-center gap-y-3">
								...
								<img
									src={personalDetails.avatarUrl ? `http://localhost:5000/${personalDetails.avatarUrl}` : `https://cdn.vectorstock.com/i/500p/17/61/male-avatar-profile-picture-vector-10211761.jpg`}
									alt="profile"
